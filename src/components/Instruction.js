  ...
  return (
    <div className={instructionClassName}>
      <p>
        ...
        companion in managing finances and achieving financial goals. This is an
        intuitive and powerful financial application that helps you track your
        finances, plan expenses, and make informed financial decisions
      </p>
      ...
      <div className={`parent ${isDarkMode ? "dark" : "light"}`}>
        ...
        <div
          className={`two ${isDarkMode ? "dark" : "light"}`}
          style={{ height: "200px" }}
        ></div>
        ...
        <div
          className={`three ${isDarkMode ? "dark" : "light"}`}
          style={{ height: "200px" }}
        ></div>
        ...
        <div
          className={`four ${isDarkMode ? "dark" : "light"}`}
          style={{ height: "150px" }}
        ></div>
        ...
        <div
          className={`five ${isDarkMode ? "dark" : "light"}`}
          style={{ height: "200px" }}
        ></div>
